...
export function CreateWorkspace({ onNavigate }: CreateWorkspaceProps) {
  const { refresh, workspaces } = useEnvironment();
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <main className="mx-auto max-w-lg px-4 py-8">
        ...
        {!canCreateWorkspace && (
          <div className="rounded-md bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-800 p-4 mb-6">
            <div className="flex">
              <svg
              ...
              <div className="ml-3">
                ...
                <p className="mt-1 text-sm text-yellow-700 dark:text-yellow-300">
                  You&apos;ve created {ownedWorkspacesCount} workspaces (maximum 3).
        ...
        {canCreateWorkspace && (
          <>
                      ...
                      >
                        ...
                        <div>
                          ...
                          <input
                            ...
                            value={tr.uri}
                            onChange={(e) =>
                              updateTargetRoot(index, "uri", e.target.value)
                            }
                ...
                <>
                  ...
                  {invites.length > 0 && (
                    <p className="mt-4 text-xs text-gray-500 dark:text-gray-400">
                      *Collaborators will <em>not</em> receive automatic invite emails
                      at the moment. You&apos;ll need to notify them directly. They will
                      see the invite once they create an account or log in.
                    </p>
                  )}
                </>
              )}
            ...
            <p className="mt-6 text-center text-sm text-gray-500 dark:text-gray-400">
              {ownedWorkspacesCount}/3 workspaces created.
            </p>
          </>
        )}
      </main>
