...
from stardag_examples.benchmarks.tasks import (
    BenchmarkTask,
    CPUBoundDynamicTask,
    CPUBoundTask,
    FileIOReadWriteTask,
...
def heavy_cpu_flat(prefix: str = "", leaf_count: int = 8) -> BenchmarkTask:
    """Heavy CPU-bound flat DAG (~1s CPU work per task).
