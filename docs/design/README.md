...
| [executions-as-records.md](executions-as-records.md)                       | Why an execution carries an identity minted before it exists, what that identity may decide, and why the table originally designed to hold it is not being built          |
