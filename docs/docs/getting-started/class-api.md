# Using the Class-API to Define Tasks
...
For more control and clarity you can define tasks by subclassing [`sd.BaseTask`](../reference/api.md#stardag.BaseTask), [`sd.TargetBaseTask`](../reference/api.md#stardag.TargetBaseTask), [`sd.Task`](../reference/api.md#stardag.Task).
