...
If you want to try something more realistic, make sure you have access to a prefect server (see [lib/stardag-examples/src/stardag_examples/ml_pipeline/README.md](./lib/stardag-examples/src/stardag_examples/ml_pipeline/README.md)) and run
...
- `@requires`/`@inherits` promotes inheritance, where composability is a superior abstraction in most cases.
- No ability to express expectaions (type hints) between tasks output and input when using composition.
